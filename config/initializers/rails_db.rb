if Object.const_defined?('RailsDb')
  RailsDb.setup do |config|
    # enabled or not
    config.enabled = Rails.env.to_s == 'production' || 'development'
    ...
    # Enable http basic authentication
    config.http_basic_authentication_user_name = 'zakaz'

    # Enable http basic authentication
    config.http_basic_authentication_password = 'spree123'
